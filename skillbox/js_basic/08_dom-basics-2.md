...
---
Список дел по умолчанию используется не вместе с локальным хранилищем. Если в локальном хранилище нет ничего, то список дел по умолчанию сохраняется в локальное хранилище. В противном случае отображается дела по умолчанию.
