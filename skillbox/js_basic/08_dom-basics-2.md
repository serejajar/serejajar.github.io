Приложение выглядит очень неплохо и вам плюсик что разобрались с локальным хранилищем. Задание выполнено на отлично!
ДЗ принято.

Что можно исправить:
- Выдает ошибку если дел нет в локальном хранилище изначально.
- Если добавить текст в поле ввода и потом удалить его, кнопка "Добавить дело" останется активной.
- По клику на кнопку "Готово" не меняются данные дела в локальное хранилище.
- По клику на кнопку "Готово" меняются данные дела в локальное хранилище, но после перезагрузки страницы цвет обозначающий статус дела не меняется, т.е. дело выглядит как активное.
...
- Можно добавить дела если введены только пробелы. Необходимо убирать пробелы с помощью метода trim и после этого добавить дело.
