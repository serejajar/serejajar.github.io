...
Вы можете объединить форму изменения клиента и форму добавления. Например, у вас есть кнопка "Сохранить", где по клику вы вызовите функцию создания createModalForm и передадите в нее данные которые нужны для отрисовки формы: заголовок, функция которая будет вызвана при клике на кнопку "Сохранить", объект с данными клиента (необязательный аргумент)
...
А в самой функции addContactSelect у вас будет уже логика добавления элементов для контакта.
