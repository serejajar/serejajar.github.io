...
- После добавления пользователя не исчезает модальное окно и не обновляется таблица. Чтобы увидеть нового пользователя нужно обновить страницу.
- При изменении пользователя таблица обновляется, но измененный пользователь не присутствует в ней.
- Адаптив. Да вы использовали вьюпорты, но если открыть ваше приложение на мобильном экране, то вы не сможете просмотреть таблицу, да и горизонтальный скролл на всей странице это не удобно для пользователя и это следует избегать.
