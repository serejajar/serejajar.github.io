...
Что можно улучшить
- В первом задании можно не использовать цикл для добавления товара в массив
for (let i = 0; i < newProducts.length; i++) {
      products.push(newProducts[i]);
}
Это работает, но можно использовать только метод push и передать ему в виде аргументов новые элементы массива:
