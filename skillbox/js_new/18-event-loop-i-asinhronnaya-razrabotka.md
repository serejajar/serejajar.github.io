Все работает по условиям задач и вам большой плюс что вы корректно использовали Promise и setTimeout. ДЗ принято.

Что можно улучшить:
- Числа в setTimeout
setTimeout(() => { ... }, 10);
setTimeout(() => { resolve(); }, 500);
Лучше вынести в отельные переменные:
...
- Смешение async/await и .then. Это работает, но стиль разный, поэтому выбирают или .then или async/await. Чтобы избегать большой вложенности рекомендую использовать async/await:
