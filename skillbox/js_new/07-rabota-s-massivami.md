...
Что можно улучшить:
- Добавить проверку prompt.  Если нажать "Отмена", то prompt вернёт null, а также можно ввести пробелы, поэтому лучше обрабатывать подобные случаи:
if (!getCartEl || !getCartEl.trim()) {
