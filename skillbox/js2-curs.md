...
По UI:
В целом все отлично но есть некоторые неточности по стилям, но не буду придираться так как для меня больше важен сам функционал. Вам плюсик за сохранение карты в локальное хранилище!
...
- Также прикрепил к письму шпаргалку по работе с API
