...
- Сейчас все файлы для фронтэнда находятся вместе с файлами сервера, их лучше вынести в отдельную папку чтобы было разделение кода. Это не критично сейчас, просто помните что клиент и бэкенд могут находиться на разных серверах.
