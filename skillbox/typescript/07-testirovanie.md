...
Рекомендации:
- Вы также можете использовать it.each или циклы в самих тестах. Это может значительно сократить код тестов
it.each([
  'a1.01.2026',
  '@1.01.2026',
  '#1.01.2026',
