...
+ Создать заметку без названия нельзя и/или описания выдает ошибку. Отлично!

Что можно исправить:

Все работает без ошибок и вам плюсик за выполнение доп. заданий. Отлично!
...
- Нет express router
- Все файлы фронэнд и бекенд частей находятся в одной папке. Если все файлы фронтенда и бэкенда находятся в одной папке, это плохо, потому что код перемешивается, из-за чего проект становится труднее поддерживать, масштабировать и понимать разработчикам.
...
1. В нем вам нужно будет найти заметку. Тут вам нужно передать id заметки в рут, чтобы получить ее.
