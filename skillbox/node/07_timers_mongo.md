Авторизация/регистрация происходит без ошибок, таймеры видны только для владельца. Все работает по условиям ДЗ. Работа выполнена на отлично!. Вам плюсик за использование router.
