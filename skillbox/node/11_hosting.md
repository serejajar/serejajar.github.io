...
http://expressjs.com
 ...
 - Я бы посоветовал изучить как работает EventLoop и Streams в NodeJS. EventLoop часто любят на собеседованиях спрашивать: да и в целом полезно знать как там устроено все. Вот цикл статей, самый подробный обзор из того что сам видел:
