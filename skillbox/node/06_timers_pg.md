Все выполнено в соответствии с заданием и вам плюсик за использование параметризованных запросов ($1, $2), защита от SQL-инъекций реализована корректно. Работа выполнена на отлично!
