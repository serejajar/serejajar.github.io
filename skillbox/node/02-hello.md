Все выполнено по условиям ДЗ! Вам плюсик за использование библиотеки moment и за то что вы не склеивали дату и время с помощью нескольких методов Date (getMonth и пр).
